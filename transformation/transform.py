...
def transformation_data():
    ...
    cities_path = "../data/bronze/my_cities.csv"
    weather_data = "../data/bronze/weather_data.json"

    new_data_ouput = "../data/silver/clean_weather_data.csv"
    ...
    print("succes to transforming and cleaning your data !!!")

    # print(final_data_frame)

    try:
        final_data_frame.to_csv(new_data_ouput, index=False)
        print(f"Success! Data imported to {new_data_ouput} !!!")
